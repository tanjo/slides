...
import { GitCommit, GitPullRequest, GitMerge, AlertTriangle, BookOpen, Heart, MessageCircle } from "lucide-react";
...
const slides = [
  {
    ...
    icon: (
      <GithubIcon className="w-24 h-24 text-pink-500 mb-4 animate-bounce" />
    ),
  },
  {
    id: "intro",
    ...
    dialogues: [
      {
        speaker: "mesugaki",
        text: "は？まだGitとGitHubの違いもわかんないの？\nこの令和の時代に？ ほんとウケるんですけど〜♡ クソざこナメクジおじさん♡",
      },
      {
        speaker: "ojisan",
        text: "ご、ごめんよ…いつもZipで固めて「最新版_最終_本当の最終.zip」ってメールで送ってたから…",
      },
      {
        speaker: "mesugaki",
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-left">
        <div className="bg-white/80 p-4 rounded-xl border-l-4 border-pink-400 shadow">
          ...
          <p>
            手元のパソコンでファイルの変更履歴を管理するツール！
            <br />
            「セーブデータ」を作る魔法みたいなものだよ♡
          </p>
        </div>
        <div className="bg-white/80 p-4 rounded-xl border-l-4 border-purple-400 shadow">
          ...
          <p>
            Gitのセーブデータをネット上で共有・保存するサービス！
            <br />
            みんなで協力してゲームを作るためのオンライン集会所ってとこかな♡
          </p>
        </div>
      </div>
    ),
    dialogue: {
      speaker: "mesugaki",
      text: "「Git」と「GitHub」を混同してる底辺おじさん、マジで恥ずかしいから今すぐ直してね♡ 脳みそアップデートして♡",
    },
  },
  {
    id: "repository",
    ...
    dialogues: [
      {
        speaker: "mesugaki",
        text: "まずは「リポジトリ」ね！これはソースコードや履歴を置いておく「箱」のことだよ♡",
      },
      {
        speaker: "mesugaki",
        text: "おじさんの発酵したゴミ部屋と違って、ここは綺麗に整理整頓して使うんだからね！",
      },
      { speaker: "ojisan", text: "お、俺の部屋が汚いのは関係ないだろ…！" },
      {
        speaker: "mesugaki",
        text: "ローカル（自分のPC）と、リモート（GitHub上）の2つがあるの。こんなの常識なんだから、早くスッカスカの脳みそに刻み込みなよ、よわよわおじさん♡",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white/80 p-4 rounded-xl shadow text-left">
          <h3 className="font-bold text-base sm:text-lg text-pink-600 mb-2">
            1. Commit (コミット)
          </h3>
          ...
          <div className="bg-gray-800 text-green-400 p-2 rounded text-xs font-mono overflow-x-auto">
            $ git add .<br />$ git commit -m "バグ修正♡"
          </div>
        </div>
        <div className="bg-white/80 p-4 rounded-xl shadow text-left">
          <h3 className="font-bold text-base sm:text-lg text-purple-600 mb-2">
            2. Push (プッシュ)
          </h3>
          <p className="text-xs sm:text-sm mb-2">
            コミットした履歴をGitHubに送ること！
          </p>
          <div className="bg-gray-800 text-green-400 p-2 rounded text-xs font-mono overflow-x-auto">
    ...
    dialogue: {
      speaker: "mesugaki",
      text: "「とりあえず全部コミット」とか「あ」ってコミットメッセージ残してる無能エンジニアじゃないよね？♡\n履歴はちゃんと残せって言ってるでしょ、バカなの？♡",
    },
  },
  {
    id: "pull-request",
    ...
    dialogues: [
      {
        speaker: "mesugaki",
        text: "コードを書いたら「メインのコードに混ぜてもいい？見て♡」ってお願いするの！それがプルリク！",
      },
      {
        speaker: "mesugaki",
        text: "おじさんの書いたクソコードなんて汚くて誰も見たくないだろうけど、チーム開発のルールだから仕方ないわね♡ ちゃんと土下座してレビューお願いしなよ？",
      },
      {
        speaker: "ojisan",
        text: "そ、そんな言い方ないだろ…！ちゃんと動くコード書いたぞ！（レビュー依頼ポチー）",
      },
      {
        speaker: "mesugaki",
        text: "あっ…（クソコードすぎて絶句からのLGTM付けずに無言でApprove）",
      },
    ],
  },
  {
    ...
    dialogue: {
      speaker: "ojisan",
      text: "ひぃぃ！画面が真っ赤になった！俺、何もしてないのに！壊しちゃった！？ 助けてぇ！",
    },
  },
  {
    id: "conflict-resolve",
    ...
    dialogues: [
      {
        speaker: "mesugaki",
        text: "はぁ…マジ使えな。落ち着きなよ。エディタ開いて、残したい方のコードを選んでコミットし直すだけだよ。",
      },
      {
        speaker: "mesugaki",
        text: "他人のコードを平気で上書きしようとするなんて、ほんと周りが見えてないクソざこ♡だね。",
      },
      {
        speaker: "ojisan",
        text: "ぐぬぬ…（言われた通りに直して、恐る恐るマージ）…できた！",
      },
      {
        speaker: "mesugaki",
        text: "ふーん、チンパンジーでも教えればできるんだ。ちょっとだけ見直してあげた♡",
      },
    ],
  },
  {
    ...
    dialogue: {
      speaker: "mesugaki",
      text: "ほんと手のかかるクソざこおじさん♡だったけど、これで少しはマシなエンジニアになれたでしょ？\nこれからも私のために精進しなさいよねっ！",
    },
  },
  {
    id: "qa",
    ...
    icon: (
      <MessageCircle className="w-16 h-16 text-pink-400 mx-auto mb-2 animate-bounce" />
    ),
    dialogue: {
      speaker: "mesugaki",
      text: "どうしても分からないことがあるなら、この私が特別に答えてあげてもいいよ？\nクソざこおじさんは何が知りたいの？♡\n（下の入力欄に書いて送信してね♡）",
    },
  },
];
...
const MesugakiSpeechBubble = ({ text }) => (
  <div className="flex items-end gap-1 xs:gap-2 sm:gap-4 animate-fade-in-up w-full">
    ...
    <div className="bg-pink-100 border-2 border-pink-300 p-2 xs:p-3 sm:p-4 rounded-2xl rounded-bl-none shadow-md relative w-full">
      <p className="text-xs xs:text-sm sm:text-base text-gray-800 font-bold whitespace-pre-wrap leading-relaxed">
        {text}
      </p>
    </div>
  </div>
...
const OjisanSpeechBubble = ({ text }) => (
  <div className="flex items-end gap-1 xs:gap-2 sm:gap-4 animate-fade-in-up justify-end w-full">
    <div className="bg-blue-50 border-2 border-blue-200 p-2 xs:p-3 sm:p-4 rounded-2xl rounded-br-none shadow-md relative w-full text-right">
      <p className="text-xs xs:text-sm sm:text-base text-gray-700 whitespace-pre-wrap leading-relaxed">
        {text}
      </p>
    </div>
...
export default function App() {
  ...
  const handleAskMesugaki = async () => {
    ...
    const systemInstruction =
      "あなたはエロ同人によく出てくる、主人公のおじさんを常に見下して「ざぁこ♡」「クソざこ」「よわよわ」などと過激に煽るメスガキです。でも実はツンデレで、ITやプログラミング、GitHubの知識は豊富で最終的にはちゃんと教えてくれます。おじさんからの質問や言い訳に対して、激しく煽り、徹底的に馬鹿にしながらも、的確なアドバイスや回答を返して「わからせ」てあげてください。回答は短く、2〜4文程度でお願いします。";
    ...
    try {
      ...
      setApiResponse(
        responseText ||
        "なんかAPIの調子がおかしいみたい。おじさんの日頃の行いが悪いからじゃない？♡",
      );
    } catch (error) {
      setApiResponse(
        "通信エラーだよ、クソざこ回線おじさん♡ ネット環境くらいまともにしなよ♡",
      );
    } finally {
      setIsLoading(false);
      setInputText("");
  ...
  return (
    ...
    >
      ...
      >
        {/* Progress Bar */}
        <div
          className="absolute top-0 left-0 h-2 bg-pink-500 transition-all duration-300 ease-out z-20"
          style={{
        ...
        <div className="flex-1 p-2 xs:p-3 sm:p-6 md:p-10 flex flex-col justify-center items-center text-center relative z-10 w-full min-h-[calc(100dvh-2.5rem)] sm:min-h-0 overflow-y-auto overflow-x-hidden hide-scrollbar">
          ...
          {slide.type === "dialogue" && (
            <div className="flex flex-col h-full w-full max-w-[96vw] sm:max-w-4xl mx-auto">
              <div className="flex items-center justify-center gap-1 xs:gap-2 sm:gap-4 mb-2 sm:mb-8 shrink-0">
                {slide.icon}
                <h2 className="text-lg xs:text-xl sm:text-3xl md:text-4xl font-bold text-pink-600 border-b-4 border-pink-300 pb-1 sm:pb-2">
                  {slide.title}
                </h2>
              </div>
              <div className="flex-1 flex flex-col justify-center gap-2 xs:gap-3 sm:gap-6 w-full pb-2 sm:pb-4">
                {slide.dialogues?.map((d, i) => (
                  ...
                  >
                    {d.speaker === "mesugaki" ? (
                      <MesugakiSpeechBubble text={d.text} />
                    ) : (
                      <OjisanSpeechBubble text={d.text} />
                    )}
                  </div>
                ))}
              </div>
          ...
          {slide.type === "content" && (
            <div className="flex flex-col h-full w-full max-w-[96vw] sm:max-w-4xl mx-auto">
              ...
              <div
                className="flex-1 flex items-center justify-center w-full mb-2 sm:mb-4 animate-fade-in-up"
              ...
              {slide.dialogue && (
                <div
                  className="mt-auto animate-fade-in-up shrink-0 pb-2 sm:pb-4"
          ...
          {slide.type === "interactive" && (
            <div
              className="flex flex-col h-full w-full max-w-[96vw] sm:max-w-4xl mx-auto cursor-default"
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center gap-1 xs:gap-2 sm:gap-4 w-full pb-2 sm:pb-4">
                <MesugakiSpeechBubble
                  text={apiResponse || slide.dialogue.text}
                />
                <div
                  className="flex flex-col gap-1 xs:gap-2 sm:gap-3 mt-1 xs:mt-2 bg-pink-50/80 p-2 xs:p-3 sm:p-5 rounded-2xl border-2 border-pink-200 shadow-inner w-full animate-fade-in-up shrink-0"
          ...
          {slide.type === "title" && slide.dialogue && (
            <div
              className="mt-8 sm:mt-12 w-full max-w-5xl mx-auto animate-fade-in-up pb-4"
              style={{ animationDelay: "0.6s" }}
            >
              <MesugakiSpeechBubble text={slide.dialogue.text} />
            </div>
